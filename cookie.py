...
if __name__ == '__main__':
    ...
    driver.find_element_by_xpath("/html/body/div[1]/div[5]/div/div[1]/div[3]/form/div[1]/div/input").send_keys("10001") # QQ号
